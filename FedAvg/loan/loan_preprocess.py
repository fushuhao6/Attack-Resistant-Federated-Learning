...
save_dirs = '../data/lending-club-loan-data/loan/'

import os
if not os.path.exists(save_dirs):
    os.makedirs(save_dirs)

save_dirs = '../data/lending-club-loan-data/'
df.to_csv(save_dirs+"loan_processed.csv",index=False,sep=',')
